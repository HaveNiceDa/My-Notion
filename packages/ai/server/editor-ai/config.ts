...
export const EDITOR_AI_SYSTEM_PROMPT = `You're manipulating a text document using HTML blocks.
...
export interface EditorAIStreamOptions {
  model: string;
  messages: OpenAI.ChatCompletionMessageParam[];
  tools?: OpenAI.ChatCompletionTool[];
}

export function buildEditorAIStreamOptions(
  options: EditorAIStreamOptions,
