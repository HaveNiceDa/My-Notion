...
export const MODELS_CONFIG: ModelConfig[] = [
  { id: "Model-1", actualModelId: "qwen-max", displayName: "Qwen Max", enabled: true },
  { id: "Model-2", actualModelId: "qwen-plus", displayName: "Qwen Plus", enabled: true },
  { id: "Model-3", actualModelId: "qwen3-coder-plus", displayName: "Qwen 3 Coder Plus", enabled: true }
];
